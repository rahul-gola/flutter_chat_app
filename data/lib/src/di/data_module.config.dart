...
import 'package:data/src/repository/auth_repository/auth_repository_impl.dart'
    as _i831;
import 'package:data/src/repository/user/chat_repository_impl.dart' as _i456;
...
import 'package:data/src/source/chat_data_source/chat_ds.dart' as _i637;
import 'package:data/src/source/chat_data_source/chat_ds_impl.dart' as _i492;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt initDataModule({
    ...
    gh.factory<_i637.ChatDataSource>(
        () => _i492.ChatDataSourceImpl(gh<_i36.FirebaseService>()));
    gh.factory<_i747.ChatRepository>(() =>
        _i456.ChatRepositoryImpl(chatDataSource: gh<_i637.ChatDataSource>()));
    return this;
  }
}
